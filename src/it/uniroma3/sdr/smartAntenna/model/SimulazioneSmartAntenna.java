...
public class SimulazioneSmartAntenna {
	...
	public void draw(){
		...
		if (this.parent.isShowInfo())
			if (this.mousePressed) 
			{
				int percentuale;
				if (this.antennaClassica != null){
					percentuale = (int) (100-100*Simulazione.dist(this.antennaClassica.getPosX(), this.antennaClassica.getPosY(), this.signalMouse.getPosX(), this.signalMouse.getPosY())/this.antennaClassica.getSize());
					this.parent.text("Ricezione segnale: "+(percentuale > 0 ? percentuale : 0)+" %", this.antennaClassica.getPosX(), this.antennaClassica.getPosY()-15);
				}
				if (this.adaptiveArray != null){
					percentuale = (int) (100-100*Simulazione.dist(this.adaptiveArray.getPosX(), this.adaptiveArray.getPosY(), this.signalMouse.getPosX(), this.signalMouse.getPosY())/this.adaptiveArray.getSize());
					this.parent.text("Ricezione segnale: "+(percentuale > 0 ? percentuale : 0)+" %", this.adaptiveArray.getPosX(), this.adaptiveArray.getPosY()-15);
				}
				if (this.switchedBeam != null){
					percentuale = (int) (100-100*Simulazione.dist(this.switchedBeam.getPosX(), this.switchedBeam.getPosY(), this.signalMouse.getPosX(), this.signalMouse.getPosY())/this.switchedBeam.getSize());
					this.parent.text("Ricezione segnale: "+(percentuale > 0 ? percentuale : 0)+" %", this.switchedBeam.getPosX(), this.switchedBeam.getPosY()-15);
				}
			}
	...
	public void mousePressed() {
		...
		this.signalMouse = SignalMouse.getInstance(this.parent);
	}
